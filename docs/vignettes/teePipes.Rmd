...
Here, the anonymous function is used to create a placeholder (`x`) and then to `plot` the `variable` and then get the `mean` of the `variable`. (For functions that print output rather than plot, additional manipulation is needed. See the implmentation of throughPipes.)
