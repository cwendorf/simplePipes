...
- [Introduction](./docs/README.md): An overview of the different types of pipes.
- [basicPipes](./docs/basicPipes.md): Basic pipes are used for chaining (rather than nesting) commands.
